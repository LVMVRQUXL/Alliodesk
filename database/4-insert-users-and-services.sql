...
VALUES ('testAdmin',
       ...
       ('test2',
        'test2@gmail.com',
        'test2',
        '60303ae22b998861bce3b28f33eec1be758a213c86c93c076dbe9f558c11c752', -- hash of 'test2'
        2);

INSERT INTO "Service"(name, version, source_url, update_config_link, user_id, service_status_id)
VALUES ('Service Test', '0.1.0', 'https://example.com', 'https://example.com', 3, 1);
